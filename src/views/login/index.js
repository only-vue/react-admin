...
class LoginForm extends React.Component {
			...
			<div className="login-warp">
				...
				<div className="main">
					...
					<div className="content">
						...
						<Form className="forms" onSubmit={this.handleSubmit} style={{ maxWidth: '300px' }}>
							<FormItem>
							...
							<FormItem>
								{getFieldDecorator('password', {
									...
									rules: [
										...
										{
											pattern: new RegExp(/^[A-Za-z0-9\u4e00-\u9fa5]+$/, "g"), max: 11, min: 11, message: '请输入输入类型为数字、字母或汉字'
										}
									],
								})(
	...
	handleSubmit = (e) => {
		...
		this.props.form.validateFields((err, params) => {
			if (!err) {
				// Loading.show();
				 storage.setStorage('user',{author:['menu1','menu2']}); //存入权限列表-对应menu的key
